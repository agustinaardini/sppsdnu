                ...
                <div class="card-body">
                    ...
                    <div class="informasi-pengirim">
                        <div class="alert alert-dark" role="alert">
                            Informasi ini dibutuhkan oleh operator sekolah agar dapat memverifikasi pembayaran yang dilakukan oleh wali murid melalui bank.
                        </div>
                    ...
                    <div class="form-check mt-3">
                        ...
                        <label for="defaultCheck3" class="form-check-label">Simpan data ini untuk memudahkan dalam pembayaran selanjutnya. </label>
                    </div>
                </div>
                <div class="divider text">
                    ...
                    <div class="informasi-bank-tujuan">
                        <div class="form-group mt-0 mb-0 pb-0">
                            ...
                            {!! Form::select('bank_id', $listBankSekolah, request('bank_sekolah_id'), ['class' => 'form-control',
