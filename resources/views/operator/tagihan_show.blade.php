...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <h5 class="card-header pb-0">DATA TAGIHAN SPP SISWA {{ strtoupper($periode) }}</h5>
                <div class="card-body">
...
<div class="row mt-2">
    <div class="col-md-5">
                ...
                <table class="table table-sm table-bordered">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td>R. {{ formatRupiah($tagihan->tagihanDetails->sum('jumlah_biaya')) }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
        ...
        <div class="card">
            ...
            <h5 class="card-header pb-0">FORM PEMBAYARAN</h5>
            <div class="card-body">
