            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="input-group">
                        <input name="q" class="form-control" placeholder="Cari Data" aria-label="Recipient's username" aria-label="cari data" aria-dscribedby="button-addon2" value="{{ request('q') }}">
